...
"spotify": '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M6.8 10.3c3.6-1 7.3-.6 10.4 1.1" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M7.2 13.2c3-.8 6-.5 8.5.9" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><path d="M7.6 15.9c2.5-.6 4.8-.4 6.8.6" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>',
"applemusic": '<svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="5" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M16 7.4v6.8a2.6 2.6 0 1 1-1.4-2.31V9.9l-4.2.9v5.4a2.6 2.6 0 1 1-1.4-2.3V8.3L16 7.4z" fill="currentColor"/></svg>',
}
